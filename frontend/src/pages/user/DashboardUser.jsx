...
export default function DashboardUser() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-gray-100">
      ...
      <button
        className="md:hidden fixed top-[100px] left-4 z-40 bg-indigo-600 text-white p-3 rounded-full shadow-lg"
        ...
        <main className="md:col-span-9 lg:col-span-10 md:ml-2">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-xl">
            ...
            <div className="flex items-center justify-between mb-4">
              ...
              <button className="px-3 py-2 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700">
                <FaBell />
              </button>
            </div>
            ...
            {/* TAB CONTENT */}
            <div className="mt-4">
              {activeTab === "new" && <RequestNew onSuccess={() => setActiveTab("active")} />}
