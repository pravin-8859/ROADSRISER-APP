  ...
  <div className="max-w-3xl text-center space-y-4">
    ...
    <div className="flex justify-center gap-6 pt-4">
      <a
        ...
        className="w-10 h-10 flex items-center justify-center rounded-full bg-gradient-to-tr from-pink-500 to-yellow-500 text-white text-lg hover:scale-110 shadow-md transition-transform duration-300"
      >
        <i className="fab fa-instagram"></i>
      </a>

      <a
        href="www.linkedin.com/in/pravin9389"
        target="_blank"
        rel="noopener noreferrer"
        className="w-10 h-10 flex items-center justify-center rounded-full bg-blue-600 text-white text-lg hover:scale-110 shadow-md transition-transform duration-300"
      >
      ...
      <a
        ...
        target="_blank"
        rel="noopener noreferrer"
        className="w-10 h-10 flex items-center justify-center rounded-full bg-blue-500 text-white text-lg hover:scale-110 shadow-md transition-transform duration-300"
      >
