    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 text-gray-800 dark:text-gray-100 transition-colors duration-500 pt-24">
      ...
      <section className="relative flex flex-col items-center justify-center text-center px-6 py-20 
        ...
        <h1 className="text-4xl md:text-5xl font-extrabold mb-4 tracking-tight">
          About <span className="text-blue-600 dark:text-blue-400">RoadsRiser</span>
        </h1>

        <p className="text-lg md:text-xl max-w-2xl text-gray-700 dark:text-gray-300 leading-relaxed">
          RoadsRiser is built to make roadside emergency help instant, easy, and reliable —
          anytime, anywhere.
        </p>
...
<section className="max-w-6xl mx-auto py-20 px-6 text-center flex flex-col items-center space-y-10">
  ...
  <div className="max-w-3xl text-center space-y-4">
    ...
    <p className="text-lg text-gray-700 dark:text-gray-300 mb-3">
            RoadsRiser is inspired by real on-road struggles faced by people when no mechanic
            is available nearby. My goal is to build India’s fastest emergency roadside assistance platform.
          </p>

          <p className="text-lg text-gray-700 dark:text-gray-300">
            With modern technology and verified mechanics, RoadsRiser ensures help reaches drivers
