...
// ===========================================================
// SEND OTP (EMAIL FIRST, PHONE OPTIONAL)
// ===========================================================
export const sendOtp = async (req, res) => {
  try {
    ...
    // 2️⃣ PHONE OTP FLOW (only if email not given)
...
export const mechanicSignup = async (req, res) => {
  try {
    ...
    if (phone && /^\d{10}$/.test(phone)) {
      mechRecord.phone = phone; // optional
    }
...
// ===========================================================
// RESET PASSWORD (still phone-based, can be adapted to email if needed)
// ===========================================================
